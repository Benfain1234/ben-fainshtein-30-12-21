  ...
  const[tempid,Settempid]=useState('')
   ...
   const onSearchChange = (event) => {
     ...
     if (event.target.value.length===3){
         axios({
             method: 'get',
             url:`https://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b&q=${event.target.value}`,
         })
   ...
   const onFevClick =(name)=>{
       axios({
           method: 'get',
           url:`https://dataservice.accuweather.com/locations/v1/cities/search?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b&q=${name}`,
       ...
       axios({
           method: 'get',
           url:"https://dataservice.accuweather.com/currentconditions/v1/215854?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b",
       })
           .then(res=> state.favorites[1]=(res.data[0]))

       axios({
           method: 'get',
           url:"https://dataservice.accuweather.com/forecasts/v1/daily/5day/215854?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b",
  ...
  console.log(state.favorites)
       ...
       for (let i=0;i<localStorage.length;i++)
       {
          let tempfav=JSON.parse((localStorage.getItem(localStorage.key(i))))
             const temppro=axios.get(`https://dataservice.accuweather.com/currentconditions/v1/${tempfav.id}?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b`)
    ...
    axios({
        method: 'get',
        url: `https://dataservice.accuweather.com/locations/v1/cities/search?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b&q=tel-aviv`,
...
const onUserSelect=(optionKey,optionName)=>{
    ...
    axios({
        method: 'get',
        url:`https://dataservice.accuweather.com/locations/v1/cities/search?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b&q=${optionName}`,
    ...
    axios({
        method: 'get',
        url: `https://dataservice.accuweather.com/currentconditions/v1/${optionKey}?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b`,
    })
        .then(res=> Setcurrentres(res.data[0]))

    axios({
        method: 'get',
        url:`https://dataservice.accuweather.com/forecasts/v1/daily/5day/${optionKey}?apikey=0qIXVD2sQihKaDSFhZnfEkseGkf2vg5b`,
