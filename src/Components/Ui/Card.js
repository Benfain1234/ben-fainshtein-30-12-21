...
const Card = ({ name,id,LocalObservationDateTime,WeatherStatus,TemperatureValue,TemperatureUnit,MonT,MonU,TueT,TueU,WedT,WedU,ThuT,ThuU,FriT,FriU,addFav,remfav}) =>



{
const favcard={name,TemperatureValue,WeatherStatus,TemperatureUnit,id}

    return (
    <div>
      <div className=' grow flex-r w-32 hover-bg-green bg-light-green br3 pa3 ma3 dib  shadow-5'>
